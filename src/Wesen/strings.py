...
STRING_USAGE_DESCRIPTION = 'Predator-prey simulation for learning python and AI. See also ' + \
    URL
STRING_USAGE_CONFIGFILE = 'specify the configfile to use, defaults to ' + \
    DEFAULT_CONFIGFILE
